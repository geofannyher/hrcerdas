            ...
            <div className="flex flex-wrap mx-10">
                <div className="w-full px-4  xl:w-3/12">
                    <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-md rounded-lg bg-blueGray-100 border-0 mt-8">
                        ...
                        <h4 className="text-center font-bold mt-4">{profile.name.first_name} {profile.name.last_name} <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">She/Her</span></h4>
                        {profile.DetailProfil !== undefined ? (
                            <div>
                                <p className="text-center font-semibold text-sm text-gray-400">{profile.DetailProfil.alamat}</p>
                                <p className="text-center font-semibold text-sm text-gray-400">{profile.DetailProfil.}</p>
