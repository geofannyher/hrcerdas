...
export default function Analytic() {
  ...
  const a = profile.positif;
  const b = profile.negatif;
  const d = 100 - a;
  const e = d - 10;
  const f = a + 10;
  const dataChart = {
  ...
  const data = {
    labels: ["Intolerant post", "Tolerant post"],
    datasets: [
      {
        label: "My First Dataset",
        data: [e, f],
        backgroundColor: ["#fb7185", "#0284c7"],
        hoverOffset: 4,
      },
    ],
  };
      ...
      <div className="flex flex-wrap px-12">
        <div className="w-full mb-12 px-2 xl:w-5/12 items-center">
          <div className="relative flex flex-wrap min-w-0 break-words w-full mb-6 shadow-md rounded-lg bg-blueGray-100 border-0 mt-8">
            ...
            <div className="xl:w-7/12 mt-4 self-center">
              <h4 className="text-left font-bold mt-4 mb-2 mx-2">
                Nama Lengkap : {`${profile.first_name}`}{" "}
                {`${profile.last_name}`}{" "}
              </h4>
              {profile === undefined ? (
                <div>
                  <p className="text-left font-semibold text-sm text-gray-400 mb-2 mx-2">
                    User Belum Menginputkan Gender
                  </p>
                  <p className="text-left font-semibold text-sm text-gray-400 mb-2 mx-2">
                    User Belum Menginputkan Status
                  </p>
                  <p className="text-left font-semibold text-sm text-gray-400 mb-2 mx-2">
                    Tempat, Negara
                  </p>
                ...
                <div>
                  <p className="text-left font-semibold text-sm text-gray-400 mb-2 mx-2">
                    Jenis Kelamnin : {`${profile.gender}`}
                  </p>
                  <p className="text-left font-semibold text-sm text-gray-400 mb-2 mx-2">
                    Status Pelamar : {`${profile.status}`}
                  </p>
                  <p className="text-left font-semibold text-sm text-gray-400 mb-2 mx-2">
                    Alamat : {`${profile.alamat}`} , {`${profile.national}`}
                  </p>
                </div>
              )}
              <p className="text-left font-semibold text-sm text-gray-400 mb-3 mx-2">
                Skills Pelamar :
              </p>
        ...
        <div className="w-full px-12 xl:w-3/12 mt-8 items-center">
          <div className="relative flex flex-col min-w-0 break-words w-full mb-8 shadow-md rounded-lg bg-blue-100 border-0  py-24">
            ...
            <p className="text-center text-blue-500 font-semibold text-md">
              Score
            </p>
          </div>
        </div>
                ...
                <div className="grid gap-6  md:grid-cols-2 m-15 border-spacing-2 ">
                  <div className="py-10 border-2 border-gray-200">
                    ...
                    >
                      <svg
                        ...
                        height="50"
                        fill="currentColor"
                        className="bi bi-facebook text-blue-700"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="py-10 border-2 border-gray-200">
                    <a
                      ...
                      target="_blank"
                      className="flex flex-auto justify-center border-slate-500"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="50"
                        height="50"
                        fill="currentColor"
                        className="bi bi-twitter text-blue-500"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="py-10 border-2 border-gray-200">
                    ...
                    >
                      <svg
                        ...
                        height="50"
                        fill="currentColor"
                        className="bi bi-linkedin text-blue-700"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="py-10 border-2 border-gray-200">
                    ...
                    >
                      <svg
                        ...
                        height="50"
                        fill="currentColor"
                        className="bi bi-instagram text-pink-500"
                        viewBox="0 0 16 16"
                      >
        ...
        <div className="w-full mb-12 px-4 xl:w-8/12">
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 mt-8 shadow-md rounded p-4 ">
            ...
            <p className="text-left text-xs font-semibold text-gray-600 mb-2">
              Data ini diambil dari analisis postingan sosial media pelamar
            </p>
        ...
        <div className="w-full mb-12 px-4 xl:w-4/12">
          <div className="relative flex flex-col min-w-0 break-words w-full mb-30 mt-8 shadow-md rounded p-4">
            ...
            <p className="text-left text-xs font-semibold text-gray-600 mb-2">
              Data ini diambil dari jumlah postingan pelamar
            </p>
            <div className="mb-7">
        ...
        <div className="w-full mb-12 px-4 xl:w-6/12">
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 mt-8 shadow-md rounded p-4">
            <div className="m-2">
              <p className="text-left text-xl font-bold text-gray-500 mb-2">
                Personality
              </p>
              <p className="text-left text-xs font-semibold text-gray-600 mb-2">
                Data ini diambil dari Analisis Teori Big Five
              </p>
              <div>
                <p className="text-left font-semibold text-sm px-4 text-green-800">
                  Openness
                </p>
                <Progressbar
                  bgcolor="#a5f3fc"
              ...
              <div>
                <p className="text-left font-semibold text-sm px-4 text-red-800">
                  Conscientiousness
                </p>
                <Progressbar
                  bgcolor="#c7d2fe"
              ...
              <div>
                <p className="text-left font-semibold text-sm px-4 text-blue-800">
                  Extraversion
                </p>
                <Progressbar
                  bgcolor="#fde68a"
              ...
              <div>
                <p className="text-left font-semibold text-sm px-4 text-yellow-800">
                  Agreeableness
                </p>
                <Progressbar
                  bgcolor="#a7f3d0"
              ...
              <div>
                <p className="text-left font-semibold text-sm px-4 text-purple-800">
                  Neuroticism
                </p>
                <Progressbar
                  bgcolor="#fef08a"
        ...
        <div className="w-full mb-12 px-4 xl:w-6/12">
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 mt-8 shadow-md rounded p-4">
            <div className="m-2">
              ...
              <p className="text-left text-xs font-semibold text-gray-600 mb-2">
                Data ini diambil dari Klasifikasi Interest sosial media
              </p>
              <div>
                <p className="text-left font-semibold text-sm px-4 text-green-800">
                  Travel
