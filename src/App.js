    ...
    return (
        <div className="container-Hero">
            <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
                ...
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className="flex md:order-2">
                        <div className="mx-4">
                            <a type="button" href="/login" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
                        </div>
                        <div>
            ...
            {/* <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                  ...
                  <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">HR Cerdas</h1>
          ...
          <footer>
            <div className="p-1  bg-black sm:p-7  dark:bg-gray-900">
              <div className="p-1  bg-black sm:p-7  dark:bg-gray-900">
                <div className="mb-6 md:mb-0">
                  <a href="/dashboard" className="flex items-center mb-5">
                    <img src={`${process.env.PUBLIC_URL}/HRCerdas.png`} className="mr-3 h-8" alt="HR Logo"/>
                    <span className="self-center text-gray-300 text-2xl font-semibold whitespace-nowrap dark:text-white">Cerdas</span>
                  </a>
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                    <h2 className="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-white">Useful Link</h2>
