            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-6/12 xl:w-3/12 px-4">
                ...
                <CardStats
                  ...
                  statIconName={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
              ...
              <div className="w-full lg:w-6/12 xl:w-3/12 px-4">
                <CardStats
                  ...
                  statIconName={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-check-fill" viewBox="0 0 16 16">
              ...
              <div className="w-full lg:w-6/12 xl:w-3/12 px-4">
                <CardStats
                  ...
                  statPercentColor="text-emerald-500"
                  statDescripiron="Since last month"
                  statIconName={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-dash-fill" viewBox="0 0 16 16">
