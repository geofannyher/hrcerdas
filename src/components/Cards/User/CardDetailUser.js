...
export default function Detail() {
  ...
  const getProfile = async (token) => {
    await axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/pelamar/getdetailpelamar/id/${id}`,
        {
          headers: {
          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2 m-6">
            <div>
              ...
              <input
                type="text"
                id="first_name"
                defaultValue={profile.name.first_name}
            ...
            <div>
              ...
              <input
                type="text"
                id="last_name"
                defaultValue={profile.name.last_name}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Doe"
                disabled
              />
            ...
            <div>
              ...
              <input
                type="text"
                id="birth"
                defaultValue={profile.DetailProfil.tanggalLahir}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
              ...
              <input
                type="text"
                id="twitter"
                defaultValue={profile.DetailProfil.gender}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="man"
                disabled
              />
            ...
            <div>
              ...
              <input
                type="text"
                id="residential"
                defaultValue={profile.DetailProfil.residentialStatus}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
              ...
              <input
                type="text"
                id="nationality"
                defaultValue={profile.DetailProfil.nationality}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
              ...
              <input
                type="text"
                id="twitter"
                defaultValue={profile.sosialMedia.twitter}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
              ...
              <input
                type="text"
                id="linkedin"
                defaultValue={profile.sosialMedia.linkedin}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                cols="6"
                defaultValue={profile.DetailProfil.location}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2 m-6">
          <div className="flex flex-wrap">
            <div className=" xl:w-3/12 px-2">
              <img
                className="w-40 h-35 rounded"
                src="https://andromedia.co.id/wp-content/uploads/2018/04/foto-capita-07.png"
                alt="Default avatar"
              />
            </div>
            <div className=" xl:w-9/12 px-2">
              ...
              <ol className="relative border-l border-gray-200 dark:border-gray-700">
                ...
                <li className="ml-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    Create New Framework Javascript
                  </h3>
                  <p className="text-base font-normal text-gray-500 dark:text-gray-400">
          ...
          <div className="flex flex-wrap">
            <div className=" xl:w-3/12 px-2">
              <img
                className="w-40 h-35 rounded"
                src="https://law.uii.ac.id/wp-content/uploads/2021/11/logo-bangkit-2022.png"
                alt="Default avatar"
              />
            </div>
            <div className=" xl:w-9/12 px-2">
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2 m-6">
          <div className="flex flex-wrap">
            ...
            <div className=" xl:w-9/12 px-2">
              ...
              <a
                href="#"
                className="inline-flex items-center mt-2 py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
              >
                Cridential{" "}
                <svg
                  className="ml-2 w-3 h-3"
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2 m-6">
          <div className="flex flex-wrap">
            <div className=" xl:w-3/12 px-2">
              <img
                ...
                src="https://www.polije.ac.id/wp-content/uploads/2021/03/LOGO-POLITEKNIK-NEGERI-JEMBER.png"
                alt="Default avatar"
              />
            </div>
            <div className=" xl:w-9/12 px-2">
          ...
          <div className="flex flex-wrap">
            <div className=" xl:w-3/12 px-2">
              <img
                className="w-20 h-20 rounded"
                src="https://global-uploads.webflow.com/62d785c9e7b9b749907a5233/62eb38a4b31a6d717886e3d8_minimal-logo-binar-academy.svg"
                alt="Default avatar"
              />
            </div>
            <div className=" xl:w-9/12 px-2">
