...
export default function CardEditFormPost({ }) {
    ...
    const editLowongan = async token => {
        const body = {
            position, placementCity, tesRequired, skill: data, jobDescription, essay, startdate, enddate, salarymax, salarymin
        }
        console.warn(body)
        await axios
            .put(
                ...
                <div className="overflow-x-auto relative">
                    ...
                    >
                        <div className="mb-6">
                            ...
                            <input type="text" onChange={(e) => setPosition(e.target.value)} id="role" defaultValue={lowongan.position} className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />

                        </div>
                        <div className="mb-6">
                            <label htmlFor="coveredArea" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Area Penugasan</label>
                            <input type="text" onChange={(e) => setPlacementCity(e.target.value)} id="coveredArea" defaultValue={lowongan.placementCity} className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <button onClick={() => setOpenModal(true)}
                                type="button" class="text-white bg-yellow-600 hover:bg-yellow-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-yellow-400 dark:hover:bg-yellow-700 focus:outline-none dark:focus:ring-yellow-800" data-modal-toggle="modalId" aria-hidden="true" data-modal-show="true">
                                Tambah Kualifikasi Skills
                            </button>
                            {openModal ? (
                                <div id="popup-modal" tabindex="-1" class=" flex justify-center backdrop-blur-sm item-center absolute overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
                                                ...
                                                <form
                                                    ...
                                                    <div className="mb-6">
                                                        <label
                                                            ...
                                                            Select 10 of your strongest skills. This will allow
                                                            recruiters to better understand your suitability for the
                                                            job.
                                                        </label>
                                                        <label
                                                            for="email"
