...
export default function CardTableListPost() {
  ...
  const getLowonganHr = async () => {
    await axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/lowonganpekerjaan/getlowonganhr`,
        {
  ...
  const getDeleteLowongan = async (id) => {
    await axios
      .delete(
        `${process.env.REACT_APP_BASE_URL}/lowonganpekerjaan/deletelowongan/id/${id}`,
        {
          headers: { Authorization: `Bearer ${token.data}` },
        }
      )
          ...
          <div className="pb-4 bg-white dark:bg-gray-900 p-2 grid grid-cols-2">
            ...
            <div className="relative mt-1">
              ...
              <input
                ...
                placeholder="Search the the job"
              />
            </div>
              ...
              {lowongan.length > 0 ? (
                lowongan.map((val) => (
                  <tr className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td className="py-4 px-6">{val.position}</td>
                    <td className="py-4 px-6">{val.start_date}</td>
                    <td className="py-4 px-6">{val.end_date}</td>
                    <td className="py-4 px-6">{val.placementCity}</td>
                    <td class="flex items-center py-4 px-6 space-x-3">
                      ...
                      {openModal ? (
                        <div
                          id="popup-modal"
                          tabindex="-1"
                          class=" flex justify-center item-center absolute overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full"
                        >
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                              ...
                              <div class="p-6 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                  Apakah anda yakin untuk menghapus lowongan
                                  ini?
                                </h3>
                                <button
                                  button
                                  onClick={() => getDeleteLowongan(val._id)}
                                  data-modal-toggle="popup-modal"
                                  type="button"
