        ...
        <>
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-md rounded-lg bg-blueGray-100 border-0 mt-8">
                ...
                {profile.DetailBasicPerusahaan !== undefined ? (
                    ...
                    <div>
                        <p className="text-center font-semibold text-sm text-gray-400">{"Tidak Terdapat Alamat"}</p>
                    </div>
                )}
                <p className="text-center font-semibold text-sm text-gray-400">{`${profile.namaPerusahaan}`}</p>
                <a href="/admin/profile/edit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none sm:w-auto m-6 focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit Profile</a>
