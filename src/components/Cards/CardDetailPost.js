                ...
                <div className="overflow-x-auto relative">
                    ...
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        {detail.length > 0 ? (
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td className="flex items-center py-4 px-6 space-x-3">
                                            ...
                                            <a href={`/admin/analytic/${val.id_pelamar}`} className="font-medium text-gray-600 dark:text-gray-500 hover:underline"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-clipboard2-data-fill" viewBox="0 0 16 16">
                            ...
                            <div class="justify-center mt-10 flex flex-auto m-20 ">
                                <div role="status">
