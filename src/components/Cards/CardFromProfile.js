...
export default function CardProfile() {
  ...
  const updateProfile = async (token) => {
    ...
    console.warn(body);
    await axios
      .put(`${process.env.REACT_APP_BASE_URL}/detailperusahaan/basic`, body, {
      ...
      <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-md rounded-lg bg-blueGray-100 border-0 mt-8">
        ...
        >
            ...
            <div>
              ...
              {profile.DetailBasicPerusahaan !== undefined ? (
                <div>
                  <input
                    type="text"
                    defaultValue={profile.DetailBasicPerusahaan.website}
              ...
              {profile.DetailBasicPerusahaan !== undefined ? (
                <div>
                  <input
                    type="text"
                    id="employes"
                    defaultValue={profile.DetailBasicPerusahaan.capacity}
                    onChange={(e) => setCapacity(e.target.value)}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Masukkan Total Pegawai Perusahaan..."
                    required
                  />
                </div>
              ) : (
              ...
              {profile.DetailBasicPerusahaan !== undefined ? (
                <div>
                  <input
                    ...
                    type="text"
                    defaultValue={
                      profile.DetailBasicPerusahaan.industrycategory
                    }
              ...
              <div>
                <div>
                  ...
                  <input
                    type="text"
                    id="address"
                    defaultValue={profile.DetailBasicPerusahaan.alamat}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    cols="6"
                    defaultValue={profile.DetailBasicPerusahaan.deskripsi}
          ...
          <button
            ...
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none m-6 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Save Data
          </button>
        </form>
